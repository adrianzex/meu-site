        ...
        <div className="grid md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
             <a 
  href="https://www.instagram.com/al_intimates.mc/" 
  target="_blank" 
  rel="noopener noreferrer"
  className="w-8 h-8 border border-background/15 flex items-center justify-center"
>
  <Instagram className="w-3.5 h-3.5" />
              </a>
              <a 
  href="mailto:adriellileodoro28@gmail.com"
  className="w-8 h-8 border border-background/15 flex items-center justify-center"
>
  <Mail className="w-3.5 h-3.5" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 font-sans text-[11px] text-background/50">
              <span>Sem Trocas e Devoluções</span>
