        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden">
              <img src={product5} alt="AL Intimates - Espartilho" loading="lazy" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="space-y-6 md:pl-8">
            ...
            <p className="font-sans text-sm text-muted-foreground leading-[1.8]">
              A AL Intimates nasceu da paixão por criar peças íntimas que fazem a mulher
            ...
            <div className="flex items-center gap-8 pt-4">
              <div className="text-center">
                ...
                <p className="font-sans text-[10px] tracking-[0.2em] uppercase text-muted-foreground">Peças Vendidas</p>
              </div>
